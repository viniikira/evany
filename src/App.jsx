    ...
    <div className="app">
      ...
      <main className="main">
        ...
        <div className="content">
          ...
          {page === 'orders' && <OrdersPage user={profile} perm={perm} rate={rate} shopifyCache={dashData.shopifyCache} initialData={dashData.orders} initialIdeas={dashData.ideas} onMutate={loadGlobalData} initialDetailId={pendingOpenOrderId} onDetailOpened={() => setPendingOpenOrderId(null)} />}
